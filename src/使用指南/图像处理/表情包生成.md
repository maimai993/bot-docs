...
:::
其中 <img src="../../img/表情包生成/4.png" width="2.5%"> 代表可修改图片表情
其中 <img src="../../img/表情包生成/5.png" width="2.5%"> 代表可修改文字表情
::: tip 提示
部分表情包 `同时` 支持修改图片和文字
:::
## 表情详情示例

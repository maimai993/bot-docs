<template><div><h1 id="踢人" tabindex="-1"><a class="header-anchor" href="#踢人"><span>踢人</span></a></h1>
...
<p><strong>指令名称</strong>: 踢人</p>
<p><strong>功能描述</strong>: 移除群成员功能</p>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-"><span class="line"><span>踢人 &#x3C;用户></span></span></code></pre>

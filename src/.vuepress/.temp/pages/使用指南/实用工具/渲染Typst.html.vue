...
<chat-panel>
<chat-message nickname="麦麦" type="user">typ #text("Hello World!")</chat-message>
...
<chat-panel>
<chat-message nickname="麦麦" type="user">teq "x = \frac{-b \pm \sqrt{b^2 - 4ac}}{2a}"</chat-message>
<chat-message nickname="麦芽糖bot" type="bot">
[图片：二次方程公式渲染结果]
</chat-message>
</chat-panel>
...
<chat-panel>
<chat-message nickname="麦麦" type="user">typ #text("彩色文字") -f red -s 24</chat-message>
<chat-message nickname="麦芽糖bot" type="bot">
[图片：红色24pt文字渲染结果]
</chat-message>
</chat-panel>
...
<chat-panel>
<chat-message nickname="麦麦" type="user">teq "\\int_{-\\infty}^{\\infty} e^{-x^2} dx = \\sqrt{\\pi}"</chat-message>
<chat-message nickname="麦芽糖bot" type="bot">
[图片：高斯积分公式渲染结果]
</chat-message>
</chat-panel>

...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-"><span class="line"><span>abbr &#x3C;text></span></span></code></pre>
...
<chat-message nickname="麦芽糖bot" type="bot">myt：没有头, 麦芽糖, 米羽糖</chat-message>
</chat-panel>
...
<chat-message nickname="麦芽糖bot" type="bot">yyds：永远滴神, 永远的神, 永远单身</chat-message>
</chat-panel>
...
<chat-message nickname="麦芽糖bot" type="bot">xswl：笑死我了, 想死我了, 想死我了</chat-message>
</chat-panel>
...
<chat-message nickname="麦芽糖bot" type="bot">未找到对应的缩写。</chat-message>
</chat-panel>
</div></template>

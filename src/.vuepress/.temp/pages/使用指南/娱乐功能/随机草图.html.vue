<template><div><h1 id="随机草图" tabindex="-1"><a class="header-anchor" href="#随机草图"><span>随机草图</span></a></h1>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-"><span class="line"><span>生草</span></span></code></pre>
...
<img src="@source/img/随机草图/1.webp" />
</chat-message>
<chat-message nickname="麦麦" type="user">生草</chat-message>
<chat-message nickname="麦芽糖bot" type="bot">
<img src="@source/img/随机草图/2.webp" />
</chat-message>

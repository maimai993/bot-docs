<template><div><h1 id="崩坏星穹铁道" tabindex="-1"><a class="header-anchor" href="#崩坏星穹铁道"><span>崩坏星穹铁道</span></a></h1>
...
<p><strong>功能描述</strong>: 查询崩坏星穹铁道游戏信息，包括折扣、简介、评分等</p>
...
<div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-"><span class="line"><span>查询 崩坏：星穹铁道</span></span></code></pre>
